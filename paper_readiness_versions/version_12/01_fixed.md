...
12. **Relative/ranking rescue tested and rejected diagnostically**: per-timestamp Spearman IC is near-zero/sign-unstable across chronological slices; fold 1 flips from +0.027 selection to -0.076 observed evaluation, while fold 2 flips from -0.022 to +0.047. Trial 871 remains untouched.
